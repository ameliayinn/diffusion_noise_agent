...
from moe_diffusion import GaussianMoEDiffusion
...
def train_deepspeed(config):
    ...
    model = GaussianMoEDiffusion(image_size=config.image_size, num_experts=4)
    ...
    for epoch in range(config.num_epochs):
        ...
        for batch in tqdm(train_loader):
            ...
            print('----****images_shape****----', images.shape)  # 应该是 [B, 1, H, W]
            ...
            # 前向扩散
            noisy_images, noise = model.forward_diffusion(
                images, t,
                sqrt_alphas_cumprod,
